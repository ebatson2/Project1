...
To start off and gain familiarity with using the Census API, we did a basic query following the [Census examples](https://api.census.gov/data/2022/acs/acs1/pums/examples.html) and class notes. We saved the query as an R object named `census_info`. This helped us by allowing us to see how using R to grab data by API works and test our helper functions.
